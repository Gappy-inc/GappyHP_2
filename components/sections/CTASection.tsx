...
export default function CTASection() {
  return (
    <section
      className="relative py-20 sm:py-28 lg:py-32 px-4 sm:px-6 text-center overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl sm:text-3xl lg:text-5xl font-bold leading-tight mb-8"
        ...
        >
          <a
            ...
            className="inline-block py-4 sm:py-5 px-7 sm:px-10 rounded-full bg-[#00E676] text-black font-extrabold text-base sm:text-lg hover:scale-[1.02] hover:shadow-[0_0_60px_rgba(0,230,118,0.5)] transition-all duration-300"
          >
            お問い合わせ / 無料PoC申し込み
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block py-4 sm:py-5 px-7 sm:px-10 rounded-full border border-white/30 text-white font-bold text-base sm:text-lg hover:bg-white/10 transition-colors"
          >
            資料ダウンロード
          </a>
        </motion.div>
